  ...
  return (
    <main className="min-h-screen bg-sky/15 px-6 py-12 lg:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        {error && <div className="my-10 border-l-2 border-destructive bg-background p-5"><p className="font-medium">A lista está protegida.</p><p className="mt-2 text-sm text-foreground/60">{error}</p><p className="mt-2 text-xs text-foreground/50">Para liberar esta conta, atribua a função de administradora no painel do Lovable Cloud.</p></div>}
